    ...
    <A.Wrapper>
      ...
      <A.Identity>
        ...
        <A.Text>
          ...
          성장과 배움이 가득했던 순간들까지. 이 모든 기억들을 영원히 간직하기
          위해, 오랫동안 보관할 수 있으며 언제든 다시 꺼내어 감상할 수 있는 CD에
          우리의 작품을 담았습니다. 우주의 어둠 속에서도 빛나는 별처럼, 우리의
          작품들은 각자의 개성과 이야기를 조명합니다. 끊임없는 노력과 열정이
          담긴 CD를 재생할 때, 그동안의 추억은 앞으로 나아갈 수 있는 발판이 될
          것입니다. 이제 우리의 CD는 책장 한켠에 넣어두고, 새로운 이야기를 써
      ...
      <A.PeopleWrap>
        <A.Inter3>위원장 : 황민지</A.Inter3>
        <A.Inter3>부위원장 : 이채은</A.Inter3>
      </A.PeopleWrap>
      <A.PeopleWrap>
        <A.People>
